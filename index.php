...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/logo.png" alt="html logo">
...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12"
                        style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">DIxItY
    ...
    <div class="copy">
        <div class="container">
            <p>Copyright &copy;2023. Made remotely by DIxItY</p>
        </div>
